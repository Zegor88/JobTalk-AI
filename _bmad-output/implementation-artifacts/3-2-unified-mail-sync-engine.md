...
- [Source: _bmad-output/planning-artifacts/epics.md#Story 3.2: Unified Mail Sync Engine]
- [Source: _bmad-output/planning-artifacts/architecture.md#Project Structure — app/services/bff.server.ts]
- [Source: _bmad-output/implementation-artifacts/3-1-oauth-secure-credential-storage.md#Dev Notes — OAuth2Client factory, session service patterns, testing patterns]
...
- [Source: _bmad-output/project-context.md#Security Rule] — never expose tokens to client
