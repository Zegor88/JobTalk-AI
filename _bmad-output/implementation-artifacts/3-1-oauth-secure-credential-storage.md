...
- [Source: _bmad-output/planning-artifacts/epics.md#Story 3.1: OAuth 2.1 & Secure Credential Storage]
- [Source: _bmad-output/planning-artifacts/architecture.md#Authentication & Security]
- [Source: _bmad-output/planning-artifacts/architecture.md#Project Structure — app/services/bff.server.ts, app/routes/login.tsx, auth.callback.tsx]
- [Source: _bmad-output/planning-artifacts/prd-jobtalk-ai.md#Non-Functional Requirements — OAuth 2.1, secure credential storage]
- [Source: _bmad-output/project-context.md#Security Rule — NEVER expose OAuth tokens to the client]
- [Source: _bmad-output/project-context.md#Framework-Specific Rules — React Router, CSS Modules]
...
- [Source: _bmad-output/implementation-artifacts/2-3-smart-replies-lightweight-composer.md#Dev Notes] — BFF route test pattern, afterEach cleanup
- [Source: _bmad-output/implementation-artifacts/deferred-work.md] — deferred API auth guards context
